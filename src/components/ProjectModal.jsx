    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto backdrop-blur-md bg-black/70 animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-3">
          <span className="px-3 py-1 rounded-full text-xs font-mono font-semibold text-[#facc15] bg-[#facc15]/10 border border-[#facc15]/25">
            {project.category}
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="p-4 rounded-xl bg-[#060a14] border border-red-500/20">
            <h4 className="text-xs font-mono uppercase tracking-wider text-[#ef4444] font-bold mb-2 flex items-center gap-2">
          ...
          <div className="p-4 rounded-xl bg-[#060a14] border border-amber-500/20">
            <h4 className="text-xs font-mono uppercase tracking-wider text-[#facc15] font-bold mb-2 flex items-center gap-2">
        ...
        {project.workflow && (
          <div className="mb-6 p-5 rounded-xl bg-[#070d1a] border border-[#facc15]/20">
            <h4 className="text-xs font-mono uppercase tracking-widest text-[#facc15] font-bold mb-4 flex items-center gap-2">
              ...
              {project.workflow.map((st) => (
                <div key={st.step} className="p-3 rounded-lg bg-[#0a1426] border border-white/5">
                  <div className="flex items-center gap-2 mb-1.5">
                    <span className="w-5 h-5 rounded-full bg-[#ef4444]/20 text-[#ef4444] text-xs font-mono font-bold flex items-center justify-center">
                      {st.step}
                    </span>
        ...
        <div className="pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-slate-900 bg-gradient-to-r from-[#facc15] via-[#fb923c] to-[#ef4444] hover:shadow-[0_0_20px_rgba(250,204,21,0.45)] transition-all"
            >
